...
public class Source
{
    ...
    public Source(Integer id, String type, String prefix, String name, String suffix, String gender,
                  String medCredential,Date dob, String solProp, String phone, Integer primarySpecialty,
